...
window.PORTFOLIO_PROJECTS.push({
    ...
    tech: ['LLM', 'Computer Vision', 'Azure', 'FastAPI', 'Kubernetes'],
    
    sub_topic: 'Kumulus',

    outcomes: `Damage assessment was previously performed manually by staff, creating a slow bottleneck whenever many cars arrived at once. With a simple photo upload, the models now identify damaged parts automatically, accelerating the workflow, eliminating the manual effort of looking up part IDs in catalogs, and significantly reducing inspection time.`,
