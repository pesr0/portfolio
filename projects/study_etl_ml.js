...
window.PORTFOLIO_PROJECTS.push({
    ...
    summary: `ETL pipeline to gather, clean, and store product listings from Mercado Livre's API into relational databases, building a reusable dataset for future ML projects.`,
